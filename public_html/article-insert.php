        ...
        <div class="mt-2" id="profile_section_mobile" style="width: 55%;position: fixed;">
         <div class="profile_dashboard_mobile"><h style="color:white;">
           <i style="color: white;" class="fa fa-navicon"></i> <span style="font-size: 1.5rem;">&nbsp Dashboard</span><i style="" class="bi bi-x close_icon"></i></h>
            ...
            <div class="machine_mobile mt-2"><a href="article-insert" style="color:white;">
  ...
  <div class="container-fluid">
      <div class="row" style="backgound:none; border:none;">
        <div class="col-md-2 col-lg-2 mt-2" id="profile_section">
            ...
            <div class="machine mt-2"><a href="article-insert" style="color:white;">
            <i style="color: white;" class="fa fa-plus-square"></i> &nbsp Insert article</a></div>
          ...
          <br />
          <form class="mt-3" action="article-insert" method="post" autocomplete="off" enctype="multipart/form-data" style="margin-left: 25px; border:2px solid #ff5733; border-radius: 5px; padding: 10px;">
            <?php echo csrf_field(); ?>
            <fieldset>
           ...
           <div class="col-12">
            ...
            <input style="text-transform: capitalize;" class="effect-3 mt-2" type="text" name="product_category" id="input_detail" placeholder="Category" required="">
              <span class="focus-border"></span>
          </div>
            <div class="col-12">
           ...
           <span class="focus-border"></span>
            ...
            <input style="visibility: hidden;" type="radio" name="product_status" value="1" checked="">
