...
<section class="w-full bg-white pt-3 pb-10 lg:pt-5 lg:pb-14 m-0 border-b border-gray-100 overflow-hidden">
...
<!-- ================= 8. WHO WE ARE SECTION (Enterprise Engineering & Proven Track Record) ================= -->
<section class="w-full bg-white py-16 lg:py-24 border-b border-gray-100 relative overflow-hidden">
  
  <!-- Subtle Ambient Background Accents -->
  <div class="absolute top-0 right-0 w-96 h-96 bg-blue-50/60 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20"></div>
  ...
  <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
      ...
      <!-- LEFT VISUAL CARD: Premium Enterprise Blueprint Grid with Glow & Floating Badges -->
      <div class="lg:col-span-6 w-full flex items-center justify-center">
        <div class="relative w-full max-w-[540px] aspect-[4/3] sm:aspect-[1.25/1] rounded-3xl bg-gradient-to-br from-[#F8FAFC] via-[#F1F5F9] to-[#E2E8F0]/80 p-6 sm:p-8 border border-blue-100 shadow-[0_20px_50px_-15px_rgba(0,82,255,0.08)] flex items-center justify-center overflow-hidden group transition-all duration-500 hover:shadow-[0_25px_60px_-12px_rgba(0,82,255,0.15)] hover:border-blue-200">
          
          <!-- Subtle Engineering Grid Lines (Interactive Blueprint Background) -->
          ...
          <!-- Ambient Radial Soft Glow Behind Icon -->
          <div class="absolute w-44 h-44 bg-gradient-to-tr from-[#0052FF]/20 to-[#38BDF8]/30 rounded-full blur-2xl pointer-events-none group-hover:scale-125 transition-transform duration-700"></div>

          <!-- Central Glowing Glassmorphism Users Icon Badge -->
          <div class="relative z-10 w-20 h-20 sm:w-24 sm:h-24 rounded-2xl bg-white/90 backdrop-blur-md border border-white/80 shadow-[0_12px_30px_-8px_rgba(0,82,255,0.25)] flex items-center justify-center group-hover:scale-110 group-hover:rotate-1 transition-all duration-500">
            <svg class="w-10 h-10 sm:w-12 sm:h-12 text-[#0052FF]" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
          ...
          <!-- Floating Architectural Feature Chip: Top-Left -->
          <div class="absolute top-5 left-5 z-10 bg-white/90 backdrop-blur-md border border-blue-100/90 rounded-full px-3.5 py-1.5 shadow-sm flex items-center gap-2 text-xs font-semibold text-gray-800 transition-transform duration-300 hover:scale-105">
            <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
            <span>Enterprise Dedicated Pods</span>
          </div>

          <!-- Floating Architectural Feature Chip: Bottom-Right -->
          <div class="absolute bottom-5 right-5 z-10 bg-white/90 backdrop-blur-md border border-blue-100/90 rounded-full px-3.5 py-1.5 shadow-sm flex items-center gap-2 text-xs font-semibold text-gray-800 transition-transform duration-300 hover:scale-105">
            <span class="text-[#0052FF] font-bold">⚡</span>
      ...
      <!-- RIGHT CONTENT: Text, Stats, and CTA -->
      <div class="lg:col-span-6 flex flex-col items-start text-left">
        
        <!-- Pre-title Pill / Tag -->
        <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-[#0052FF] text-[11px] sm:text-xs font-bold uppercase tracking-widest mb-4">
          <span class="w-1.5 h-1.5 rounded-full bg-[#0052FF]"></span>
          WHO WE ARE
        </div>

        <!-- Main Headline -->
        <h2 class="text-2xl sm:text-3xl lg:text-[2.15rem] font-bold text-[#0F172A] tracking-tight leading-[1.35] mb-6">
          We are Creed Tech, an enterprise software development company committed to quality engineering, transparent partnership, and dependable delivery.
        </h2>

        <!-- Subtle Divider -->
        <div class="w-full h-px bg-gradient-to-r from-gray-200 via-gray-100 to-transparent mb-8"></div>

        <!-- Stats Grid -->
        <div class="flex items-center gap-12 sm:gap-16 mb-8">
          
          <!-- Stat 1 -->
          <div class="flex flex-col">
            <div class="flex items-baseline">
              <span class="text-4xl sm:text-5xl font-extrabold text-[#0F172A] tracking-tight">10</span>
              <span class="text-3xl sm:text-4xl font-extrabold text-[#0052FF] ml-0.5">+</span>
            </div>
            <span class="text-xs sm:text-sm font-medium text-gray-500 mt-1 uppercase tracking-wider">Years Experience</span>
          </div>
          ...
          <div class="flex flex-col">
            <div class="flex items-baseline">
              <span class="text-4xl sm:text-5xl font-extrabold text-[#0F172A] tracking-tight">50</span>
              <span class="text-3xl sm:text-4xl font-extrabold text-[#0052FF] ml-0.5">+</span>
            </div>
            <span class="text-xs sm:text-sm font-medium text-gray-500 mt-1 uppercase tracking-wider">Global Projects</span>
          </div>
        ...
        <!-- CTA Button -->
        <div>
          <a href="about" class="btn-blue flex items-center gap-2 group">
            <span>Our Story</span>
