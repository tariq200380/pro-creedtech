...
/**
 * Isolated Success Stories Edit Image Optimizer
 ...
 */
function optimize_stories_edit_image($sourcePath, $maxWidth = 1600, $maxHeight = 1200, $quality = 82) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_submit'])) { 
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        if (!$uploadResult['success']) {
            ...
            // Attempt isolated Success Stories Edit WebP auto-optimization
            $optimizedResult = optimize_stories_edit_image($uploadResult['filepath'], 1600, 1200, 82);
            if (
                ...
                creed_audit_log('UPLOAD_ACCEPTED', 'STORY', $id, 'SUCCESS', [
            ...
            if ($newImageName !== null) {
                ...
                if ($stmtUp) {
                    ...
                    if (mysqli_stmt_execute($stmtUp)) {
                        ...
                        creed_audit_log('UPDATE_FAILED', 'STORY', $id, 'FAILURE', ['error' => mysqli_stmt_error($stmtUp)]);
                    }
                    ...
                    creed_audit_log('UPDATE_FAILED', 'STORY', $id, 'FAILURE', ['error' => mysqli_error($connect)]);
                }
            } else {
