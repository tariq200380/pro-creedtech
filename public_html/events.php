...
<head>
  ...
  <title>CreedTech - Events Dashboard</title>
...
<body>
  ...
  <section style="background-color: #F1F1F1; margin-top: 80px; min-height: 80vh;">
    <div class="container">
      <h1 class="text-center" style="color: #0B21E1; margin-bottom: 30px;"><b>Events Management</b></h1>
      <div class="row">
        <?php 
        if ($connect instanceof mysqli) {
          $res = mysqli_query($connect, "SELECT * FROM `events` ORDER by id DESC");
          if ($res) {
            while ($row = mysqli_fetch_assoc($res)) {
              ...
              <div class="col-md-4 col-lg-3 mt-4" style="padding:10px; border-radius:5px; background:white; box-shadow: 1px 1px 10px 0px lightgray;">
                ...
                <div class="d-flex justify-content-between mt-3">
                  <a href="events_edit.php?id='.$id.'" class="btn btn-sm btn-primary" style="width:48%;">Edit</a>
                  <form method="POST" action="events_delete.php" style="width:48%; display:inline;" onsubmit="return confirm(\'Are you sure you want to delete?\');">
                    '.$csrf.'
