 ...
 */
function optimize_blog_image($sourcePath, $maxWidth = 1600, $maxHeight = 1200, $quality = 82) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['form_submit'])) {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        if (!$uploadResult['success']) {
            ...
            // Attempt isolated Blog WebP auto-optimization
            $optimizedResult = optimize_blog_image($uploadResult['filepath'], 1600, 1200, 82);
            if ($optimizedResult['success']) {
                ...
                creed_audit_log('UPLOAD_ACCEPTED', 'BLOG', null, 'SUCCESS', [
